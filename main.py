...
min_dict = {time_list[0]: 6000, time_list[1]: 11000, time_list[2]: 13000, time_list[3]: 13100, time_list[4]: 14000, time_list[5]: 14100, time_list[6]: 22222}
# 最大步数（例如现在设置意思是在8点（你设置的第一个时间点默认8）运行会在1500到2999中随机生成一个数提交（开启气候降低步数会乘系数K）10点3000~4999。。。以此类推，步数范围建议看懂了再改，没看懂直接默认就好）
max_dict = {time_list[0]: 9999, time_list[1]: 12999, time_list[2]: 13099, time_list[3]: 13999, time_list[4]: 14099, time_list[5]: 14999, time_list[6]: 22223}
# 设置结束
